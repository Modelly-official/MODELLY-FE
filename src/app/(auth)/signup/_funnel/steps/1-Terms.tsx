...
export const StepTerms: React.FC<StepTermsProps> = ({ goNext, isSocial }) => {
  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-white font-sans">
      ...
      <div
        className="mx-4 mt-6 flex w-[calc(100%-2rem)] cursor-pointer items-center gap-4 rounded-xl bg-gray-100 p-4 sm:w-[343px]"
      ...
      <div className="mx-4 mt-4 flex w-[calc(100%-2rem)] flex-col gap-2 sm:w-[343px]">
        {terms.map((term, idx) => (
          <div
            key={term.label}

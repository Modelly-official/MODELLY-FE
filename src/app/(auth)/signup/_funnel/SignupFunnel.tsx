...
import { StepTerms, StepRole, StepBasicInfo, StepLoginInfo, StepProfileInfo, StepComplete } from '.';
    ...
    <div className="relative min-h-screen bg-white">
      <Funnel>
        ...
        <Funnel.Step name="basicInfo">
          <StepBasicInfo goNext={() => setStep('loginInfo')} goPrev={() => setStep('role')} isSocial={isSocial} />
        </Funnel.Step>

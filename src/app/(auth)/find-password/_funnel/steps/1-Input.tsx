    ...
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <form className="mx-4 mt-8 flex flex-1 flex-col gap-6" onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            type="text"
            className="text-body-2-medium rounded-xl bg-gray-100 px-4 py-[14px] tracking-tight text-gray-900 placeholder:text-gray-600 focus:placeholder:text-transparent focus:outline-none disabled:text-gray-700"

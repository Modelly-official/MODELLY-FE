...
export const mockRecruitmentDetail: RecruitmentDetail = {
  ...
  notice:
    '• 시술 전 최소 3개월 이상 염색이나 펌을 하지 않은 모발이어야 합니다.\n• 모발 길이는 어깨 아래 정도로 충분한 길이가 필요합니다.\n• 두피나 모발에 특이사항이 있으신 경우 사전에 말씀해주세요.\n• 시술 당일 예약 시간을 꼭 지켜주세요.',
  goal1: '자연스러운 레이어드 컷으로 얼굴형에 맞는 스타일 연출',
  goal2: '부드러운 웨이브 펌으로 볼륨감 있는 헤어스타일 완성',
  goal3: '고품질 제품 사용으로 모발 손상 최소화',
  imageUrls: [

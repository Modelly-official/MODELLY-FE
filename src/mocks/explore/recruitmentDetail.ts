...
export const mockRecruitmentDetail: RecruitmentDetail = {
  ...
  notice: '시술 후 홈케어 방법과 스타일링 팁도 자세히 알려드립니다. 궁금한 점이 있으시면 언제든 문의해주세요!',
  restriction: '탈색 2회 이상 불가능',
  goal1: '포트폴리오',
  imageUrls: [
...
export const mockRecruitmentDetail2: RecruitmentDetail = {
  ...
  notice: '염색 후 컬러 유지를 위한 홈케어 제품도 추천해드립니다.',
  restriction: '• 최근 3개월 이내 염색 이력이 없으신 분\n• 탈색이 필요할 수 있습니다\n• 두피 민감도 테스트 필수',

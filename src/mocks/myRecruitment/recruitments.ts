...
export const mockMyRecruitmentItems: MyRecruitmentListItem[] = [
  {
    ...
    earliestRecruitmentDate: '2025-12-28',
  ...
  },
  {
    recruitmentId: 2,
    title: '네일 아트 모델 구해요',
    earliestRecruitmentDate: '2025-12-30',
  ...
  },
  {
    recruitmentId: 3,
    title: '펌 모델 급구',
    earliestRecruitmentDate: '2026-01-05',
  ...
  },
  {
    recruitmentId: 4,
    title: '염색 모델 모집',
    earliestRecruitmentDate: '2026-01-10',
  ...
  },
  {
    recruitmentId: 5,
    title: '속눈썹 연장 모델',
    earliestRecruitmentDate: '2026-01-15',

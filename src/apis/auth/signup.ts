...
import type { ApiResponse, SignupRequest, SignupResponse, SmsResponse, DuplicateCheckResponse } from '@/src/types';
...
// SMS 인증번호 검증
export const verifySmsCode = async (phoneNumber: string, authCode: string): Promise<ApiResponse<SmsResponse>> => {

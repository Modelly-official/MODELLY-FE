      ...
      <div className="flex gap-2">
        <button
          ...
          className={`flex-1 py-3 rounded-xl text-body-2-medium cursor-pointer ${
            value === '남자' ? 'bg-blue-600 text-white border-none' : 'bg-white text-gray-600 border border-gray-400'
          }`}
        >
          남자
        </button>
        <button
          ...
          onClick={() => onChange('여자')}
          className={`flex-1 py-3 rounded-xl text-body-2-medium cursor-pointer ${
            value === '여자' ? 'bg-blue-600 text-white border-none' : 'bg-white text-gray-600 border border-gray-400'
          }`}
        >
          여자
        </button>

      ...
      >
        ...
        <div className="ml-3 min-w-0 flex-1">
          ...
          <div className="flex items-center justify-between">
            <span className="text-body-1-medium max-w-[224px] truncate text-gray-900">
              {chat.name}
            </span>
          ...
          <div className="mt-[2px] flex items-center justify-between">
            <span
              className={`text-body-2-medium max-w-[224px] truncate ${hasUnread ? 'text-gray-900' : 'text-gray-700'}`}
            >
              {chat.lastMessage}
            </span>
            {hasUnread && (

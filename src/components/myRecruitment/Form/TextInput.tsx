  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <input
        ...
        className="text-body-2-medium w-full rounded-xl bg-gray-100 px-4 py-[14px] text-gray-900 placeholder:text-gray-600 focus:outline-none focus:placeholder:text-transparent"
      />
    </div>
  );
}

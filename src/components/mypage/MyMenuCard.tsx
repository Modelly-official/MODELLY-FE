...
export const MyMenuCard = ({ actions }: { actions: MyMenu[] }) => {
          ...
          return (
            <div key={label} className="relative px-2.5">
              ...
              <button
                type="button"
                onClick={onClick}
                className={`flex w-full flex-col items-center justify-center gap-2 ${paddingX} cursor-pointer py-[9px] text-gray-900`}
              >
